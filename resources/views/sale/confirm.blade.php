            ...
            <div class="service-card">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-6">
                        ...
                        {!! Form::text('recibo', null, ['class' => 'form-control', 'placeholder' => 'Ejemplo: 399', 'id' => 'recibo', 'autocomplete' => 'off']) !!} <br>
                        {!! Form::text('Precio', 0, ['class' => 'form-control', 'placeholder' => 'Ejemplo: 399', 'id' => 'cambio', 'autocomplete' => 'off', 'readonly']) !!} <br>
                        {!! Form::text('total', null ,['class' => 'form-control', 'placeholder' => 'Ejemplo: 399', 'id' => 'total', 'autocomplete' => 'off', 'readonly']) !!} <br>
                    </div>
